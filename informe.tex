...
\begin{abstract}
Lo principal en este documento es dejar especificado los requerimientos, los análisis que hicimos de estos, el posterior desarrollo y finalmente fijar una planificación de las metas a cumplir por semana hasta llegada la fecha de entrega del proyecto. Para esto debemos obtener, analizar, documentar, verificar,y validar los requisitos del clientes(proyecto).En base a diagramas lograr una estructura a desarrollar para poder realizar una plataforma completa.
\end{abstract}

\section{Introducción}

En una primera instancia se nos dio la opción de decidir por 4 proyectos distintos pero con un enfoque claro en la recopilación de datos por medio de cámaras. Nosotros hemos decidido uno de estos, que consiste en el conteo de votos automático a mano alzada por medio de cámaras, este conteo puede ser anónimo o no, que a continuación sera especificado mas detalladamente cuales son y como se desean implementar estos requerimientos.

\section{Toma de requerimientos-análisis- desarrollo-planificación}
