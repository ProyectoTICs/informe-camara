...
\title{Sistema de votación por reconocimiento automático}
%
...
RF7 &Hacer encuesta& Se le permite al  \\ 
						& & usuario crear una  \\ 
						& & encuesta o pregunta \\ 
						& & para ser respondida.\\\hline
RF8 &Ingresar alternativas &El usuario ingresa  \\ 
						& & las alternativas que  \\ 
						& & se pondrán a elección.\\\hline
RF9 &Recopilar respuestas& Por cada alternativa  \\ 
						& & se recogen los datos  \\ 
						& & observados por la   \\ 
						& & cámara.\\\hline
RF10 &Analizar resultados& Procesar los datos \\ 
						& & que se recogieron  \\ 
						& & para identificar los \\
						& & aciertos y errores. \\\hline	
RF11 &Mostrar resultados& Mostrar gráficas\\ 
...
\begin{figure*}[h]
  \centering
  \includegraphics[angle=90,width=1\linewidth]{Encuestamatic}
  \caption{Carta gantt.}
  \label{fig:sim2}
\end{figure*}
% Referencias
